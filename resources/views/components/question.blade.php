   ...
   <div>
    <x-form :action="route('question.like', $question)" :method="'POST'">
        <button class="flex items-start space-x-2 text-green-500">
            <x-icons.thumbs-up class="w-5 h-5 text-green-700 hover:text-green-300 cursor-pointer" />
    ...
    <x-form :action="route('question.like', $question)" :method="'POST'">
        ...
        <x-icons.thumbs-down class="w-5 h-5 text-red-700 hover:text-red-300 cursor-pointer" />
